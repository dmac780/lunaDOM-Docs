// lunadom/components/file-input/file-input.js

/**
 * @customElement luna-file-input
 * 
 ...
 * @cssprop --luna-file-input-bg - Background color of the dropzone.
 * @cssprop --luna-file-input-border - Border color of the dropzone.
 * @cssprop --luna-file-input-color - Text color inside the dropzone.
 * @cssprop --luna-file-input-radius - Border radius of the dropzone.
 * @cssprop --luna-file-input-accent - Accent color for drag-over state.
 * @cssprop --luna-file-input-shadow - Box shadow when dragging over.
 * 
 * Events:
 * @event luna-change - Emitted when files are selected or removed. Detail contains { files: File[] }.
 * @event luna-remove - Emitted when a file is removed. Detail contains { file: File, index: number }.
 * 
 * Properties:
 * @property {File[]} files - Array of selected files. Must be reassigned (not mutated) to trigger updates.
 */
class LunaFileInput extends HTMLElement {
  ...
  set files(filesArray) {
    if (!Array.isArray(filesArray)) {
      console.warn('luna-file-input: files must be an array');
      return;
    }
  ...
  _removeFile(index) {
    ...
    this.dispatchEvent(new CustomEvent('luna-remove', {
      bubbles: true,
      composed: true,
    ...
    this.shadowRoot.innerHTML = `
      <style>
        :host {
          display: block;
          font-family: inherit;
          --luna-file-input-bg: rgba(26, 26, 26, 0.5);
          --luna-file-input-border: rgba(255, 255, 255, 0.1);
          --luna-file-input-color: #eee;
          --luna-file-input-radius: 12px;
          --luna-file-input-accent: var(--luna-accent, #2563eb);
          --luna-file-input-shadow: 0 0 0 3px rgba(37, 99, 235, 0.2);
        }
        ...
        .dropzone {
          ...
          min-height: 180px;
          padding: 2rem;
          border: 2px dashed var(--luna-file-input-border);
          border-radius: var(--luna-file-input-radius);
          background: var(--luna-file-input-bg);
          backdrop-filter: blur(12px);
          -webkit-backdrop-filter: blur(12px);
          cursor: pointer;
          transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
          text-align: center;
          color: var(--luna-file-input-color);
        }
        ...
        .dropzone.dragging {
          border-color: var(--luna-file-input-accent);
          background: rgba(37, 99, 235, 0.05);
          box-shadow: var(--luna-file-input-shadow);
        ...
        .dropzone.dragging .dropzone-icon {
          color: var(--luna-file-input-accent);
        }
...
customElements.define('luna-file-input', LunaFileInput);
