// lunadom/components/animation/animation.js
 ...
 * @cssprop --luna-radius - Border radius for the animation
 */
class LunaAnimation extends HTMLElement {
...
customElements.define('luna-animation', LunaAnimation);