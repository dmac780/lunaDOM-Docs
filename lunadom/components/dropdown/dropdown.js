...
/**
 * @customElement luna-dropdown
 * 
 * @slot - The content of the dropdown panel (typically luna-menu).
 ...
 * @cssprop --luna-dropdown-bg - Background color of the dropdown panel.
 * @cssprop --luna-dropdown-border - Border color of the dropdown panel.
 * @cssprop --luna-dropdown-radius - Border radius for the panel corners.
 * @cssprop --luna-dropdown-shadow - Box shadow for the panel.
 * @cssprop --luna-dropdown-z - Z-index for the panel.
 * 
 * Events:
 * @event luna-show - Emitted when the dropdown panel opens.
 * @event luna-hide - Emitted when the dropdown panel closes.
 */
class LunaDropdown extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        :host {
          ...
          --luna-dropdown-radius: 12px;
          --luna-dropdown-shadow: 0 10px 40px -10px rgba(0, 0, 0, 0.7), 
                                 0 0 1px 1px rgba(255, 255, 255, 0.05);
          --luna-dropdown-z: 1000;
        }
        ...
        .panel {
          position: absolute;
          min-width: 12rem;
          background: var(--luna-dropdown-bg);
          border: 1px solid var(--luna-dropdown-border);
          border-radius: var(--luna-dropdown-radius);
          box-shadow: var(--luna-dropdown-shadow);
          z-index: var(--luna-dropdown-z);
          padding: 0.5rem;
          margin: 0;
          list-style: none;
      ...
      <div class="panel ${placement}" id="panel" part="panel">
        <slot></slot>
      </div>
    `;
...
customElements.define('luna-dropdown', LunaDropdown);