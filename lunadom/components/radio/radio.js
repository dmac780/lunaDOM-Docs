// lunadom/components/radio/radio.js

/**
 * @customElement luna-radio
 * 
 ...
 */
class LunaRadio extends HTMLElement {
  ...
  _checkSelf() {
    const group = document.querySelectorAll(
      `luna-radio[name="${CSS.escape(this.name)}"]`
    )
...
customElements.define('luna-radio', LunaRadio)