// lunadom/components/relative-time/relative-time.js

/**
 * @customElement luna-relative-time
 * 
 * Attributes:
 ...
 */
class LunaRelativeTime extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <span part="time">${text}</span>
    `;
  }
}

customElements.define('luna-relative-time', LunaRelativeTime);