// lunadom/components/option/option.js

/**
 * @customElement luna-option
 * 
 ...
 * @cssprop --luna-accent - Color used for the selected state indicator and text.
 */
class LunaOption extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .option.selected::before {
          ...
          bottom: 0;
          width: 3px;
          background: var(--luna-accent, #3b82f6);
...
customElements.define('luna-option', LunaOption);