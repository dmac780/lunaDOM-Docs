// lunadom/components/radio-group/radio-group.js

/**
 * @customElement luna-radio-group
 * 
 * @slot - List of luna-radio or luna-radio-button components.
 * 
 * Attributes:
 ...
 */
class LunaRadioGroup extends HTMLElement {
  ...
  _radios() {
    return [...this.querySelectorAll('luna-radio, luna-radio-button')]
  }
  ...
  _attachEvents() {
    this.addEventListener('luna-change', e => {
...
customElements.define('luna-radio-group', LunaRadioGroup)