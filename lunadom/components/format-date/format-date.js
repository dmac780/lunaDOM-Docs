// lunadom/components/format-date/format-date.js

/**
 * @customElement luna-format-date
 *
 ...
 * Pairs naturally with luna-date-picker output.
 *
 * Attributes:
 * @attr {string} value
 ...
 */
class LunaFormatDate extends HTMLElement {
...
customElements.define('luna-format-date', LunaFormatDate);