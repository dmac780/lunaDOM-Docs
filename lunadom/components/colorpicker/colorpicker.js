/**
 * @customElement luna-color-picker
 * 
 ...
 * @cssprop --luna-picker-border-radius - Border radius for picker elements. Defaults to 10px.
 * @cssprop --luna-picker-panel-bg - Background color of the picker panel. Defaults to #1a1a20.
 * @cssprop --luna-picker-panel-border - Border style for the panel. Defaults to 1px solid #2e2e38.
 * @cssprop --luna-picker-panel-shadow - Box shadow for the popup panel.
 * @cssprop --luna-picker-trigger-bg - Background color of the trigger button.
 * @cssprop --luna-picker-trigger-border - Border style for the trigger button.
 * @cssprop --luna-picker-trigger-color - Text color of the trigger button.
 * @cssprop --luna-picker-input-bg - Background color of input fields.
 * @cssprop --luna-picker-input-border - Border style for input fields.
 * @cssprop --luna-picker-input-color - Text color of input fields.
 * @cssprop --luna-picker-input-radius - Border radius for input fields.
 * @cssprop --luna-picker-focus-ring - Focus ring style.
 * @cssprop --luna-picker-swatch-size - Size of swatch buttons. Defaults to 24px.
 * @cssprop --luna-picker-swatch-radius - Border radius of swatch buttons. Defaults to 6px.
 * @cssprop --luna-picker-thumb-size - Size of slider thumbs. Defaults to 14px.
 * @cssprop --luna-picker-track-height - Height of slider tracks. Defaults to 12px.
 * 
 * Events:
 * @event color-change - Emitted when the color value changes. Detail contains hex, rgb, alpha, value, h, s, v.
 * @event luna-change - Alias for color-change, for consistency with other luna components.
 */
class LunaColorPicker extends HTMLElement {
...
customElements.define('luna-color-picker', LunaColorPicker);
