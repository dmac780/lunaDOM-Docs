// lunadom/components/input/input.js

/**
 * @customElement luna-input
 * 
 ...
 * @cssprop --luna-input-bg - Background color of the input wrapper.
 * @cssprop --luna-input-border - Border color of the input wrapper.
 * @cssprop --luna-input-color - Text color of the input.
 * @cssprop --luna-input-focus - Border color when focused.
 * @cssprop --luna-input-focus-alpha - Shadow color when focused (alpha).
 * @cssprop --luna-input-radius - Border radius of the input wrapper.
 * @cssprop --luna-input-padding - Internal padding of the input field.
 * 
 * Events:
 * @event input - Emitted when the input value changes.
 * @event luna-clear - Emitted when the input is cleared via the clear button.
 */
class LunaInput extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        :host {
          display: block;
          font-family: inherit;
          --luna-input-bg: #1a1a1a;
          --luna-input-border: #333;
          --luna-input-color: #eee;
          --luna-input-focus: var(--luna-accent, #2563eb);
          --luna-input-radius: 8px;
          --luna-input-padding: 0.625rem 0.75rem;
          width: 100%;
        }
        ...
        .input-wrapper {
          ...
          border: 1px solid var(--luna-input-border);
          border-radius: var(--luna-input-radius);
        ...
        .input-wrapper:focus-within:not(.disabled) {
          border-color: var(--luna-input-focus);
          box-shadow: 0 0 0 3px var(--luna-input-focus-alpha, rgba(37, 99, 235, 0.2));
        }
        ...
        input {
          ...
          border: none;
          color: var(--luna-input-color);
          font: inherit;
          padding: var(--luna-input-padding);
          outline: none;
          width: 0;
          min-width: 0;
        }
        ...
        /* Sizes */
        :host([size="sm"]) { --luna-input-padding: 0.4rem 0.6rem; --luna-input-radius: 6px; }
        :host([size="sm"]) input { font-size: 0.8125rem; }
        :host([size="lg"]) { --luna-input-padding: 0.8rem 1rem; --luna-input-radius: 10px; }
        ...
        ::slotted([slot="prefix"]), ::slotted([slot="suffix"]) {
          ...
          height: 100%;
          border-right: 1px solid var(--luna-input-border);
        }

        ::slotted([slot="suffix"]) {
          border-right: none;
          border-left: 1px solid var(--luna-input-border);
        }
      </style>
...
customElements.define('luna-input', LunaInput);